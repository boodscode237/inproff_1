                ...
                <Tilt>
                    <div className="container h-96 w-96 bg-white bg-opacity-10 rounded-2xl shadow-5xl relative z-2 border border-opacity-30 border-r-0 border-b-0 backdrop-filter backdrop-blur-sm">
                        <form className='h-full flex flex-col justify-evenly items-center'>
                            <div className='text-white font-poppins text-2xl tracking-widest'>Свяжитесь с нами</div>
                            <input type="text" placeholder='Название команды' className='input-text'/>
                            <input type="text" placeholder='Сообщение' className='input-text'/>
